...
if($_POST) {
    ...
    $to_Email = "jeff@jeffreymclean.com"; // Write your email here
    ...
    if(!$Mailsending) {
        ...
        $output = json_encode(array('type'=>'message', 'text' => '<i class="icon ion-checkmark-round"></i> Thanks '.$_POST["userName"] .'. Your message has been sent, I will get back to you asap!'));
        die($output);
    }
}
?>